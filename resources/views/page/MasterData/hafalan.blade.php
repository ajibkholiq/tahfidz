                    ...
                    <div class="form-horizontal">
                        ...
                        <div id="nilai" style="display: none">
                            <div class="form-group"><label class="col-sm-3 control-label">Kefasihan</label>
                                <div class="col-sm-9"><input type="number" placeholder="Kefasihan" name="kefasihan" id="kefasihan" required
                                        class="form-control"></div>
                            </div>
                            <div class="form-group"><label class="col-sm-3 control-label">Tajwid</label>
                                <div class="col-sm-9"><input type="number" placeholder="Tajwid" name="tajwid" id="tajwid" required
                                        class="form-control"></div>
                            </div>
                            <div class="form-group"><label class="col-sm-3 control-label">Kelancaran</label>
                                <div class="col-sm-9"><input type="number" placeholder="kelancaran" id="kelancaran" name="kelancaran"
                                        required class="form-control"></div>
                            </div>
                            <div class="form-group"><label class="col-sm-3 control-label">Catatan</label>
                                <div class="col-sm-9"><input type="text" placeholder="Catatan" id="Catatan" name="catatan"
                                        class="form-control"></div>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-9 col-sm-offset-3" style="text-align: end">
                                ...
                                <button class="btn btn-primary" style ="display: none"id="save">Save</button>
